          ...
          <div class="flex items-center relative w-full">
            ...
            <div class="ml-14 pt-0.5 w-full">
              ...
              <div class="text-[15px] font-light">
                ...
                Curabitur sit amet eros eget libero fermentum pulvinar. Sed ut
                diam sapien. Vivamus vitae nunc ac felis dapibus vulputate. Cras
                tincidunt, dolor ac interdum condimentum, nunc lectus pharetra
                nisi, id sollicitudin turpis nunc ac leo.
              </div>
            </div>
          </div>
        </div>
