<template>
  <div id="PostMain" class="flex border-b py-6">
    <div class="cursor-pointer">
      <img class="rounded-full max-h-[60px]" width="60" src="https://picsum.photos/id/8/300/320" alt="post">
    </div>
    <div class="pl-3 w-full px-4">
      ...
      <div class="mt-2.5 flex">
        <div class="relative min-h-[400px] max-h-[580px] max-w-[260px] flex items-center bg-black rounded-xl cursor-pointer">
          <video
              ref="videoRef"
              loop
              muted
        ...
        <div class="relative mr-[75px]">
          <div class="absolute bottom-0 pl-2">
            ...
            <div class="pb-4 text-center">
              ...
              <span class="text-xs text-gray-800 font-semibold">1005</span>
            </div>
            <div class="pb-4 text-center">
              <button class="rounded-full bg-gray-200 p-2 cursor-pointer">
                <Icon name="ri:share-forward-fill" size="25"/>
              </button>
              <span class="text-xs text-gray-800 font-semibold">200</span>
            </div>
          </div>
        </div>
      </div>
